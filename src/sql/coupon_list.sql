...
comment on column coupon_list.coupon_date_type is '발행 기간 구분 (free/after/date)';
comment on column coupon_list.coupon_date_value is '발행 기간 구분 값';
comment on column coupon_list.coupon_start_date is '발행 기간 시작';
comment on column coupon_list.coupon_end_date is '발행 기간 끝';
