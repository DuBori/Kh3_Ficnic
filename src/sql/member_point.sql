...
insert into member_point values(1, null, null, 'test1', 'plus', 1000, '회원가입 축하 적립금 지급', sysdate);
insert into member_point values(2, null, null, 'test2', 'plus', 1000, '회원가입 축하 적립금 지급', sysdate);
insert into member_point values(3, null, 1, 'test1', 'plus', 500, '상품 후기 작성 적립금 지급', sysdate);
insert into member_point values(4, null, 2, 'test1', 'plus', 500, '상품 후기 작성 적립금 지급', sysdate);
