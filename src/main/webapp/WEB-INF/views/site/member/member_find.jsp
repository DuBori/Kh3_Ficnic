...
<body>
	...
	<div align="center">
    <form name="find_form" method="post" action="<%=request.getContextPath()%>/site/member/member_find_id_result.do">
    
	<h2>아이디/ 비밀번호 찾기</h2>
            <a href="javascript:location.reload();" class="login-tab-list__item active" role="tab" aria-controls="tab-panel1">아이디 찾기</a>
            <a href="<%=request.getContextPath()%>/site/member/member_find_pw.do" class="login-tab-list__item" role="tab" aria-controls="tab-panel2">비밀번호 찾기</a>
