...
<div class="contents w1100 member-join">
			...
			<!-- 아이디 -->
				...
				<input type="text" class="form-control join_id"  id="member_id" name="member_id" placeholder="6자 이상을 입력해주세요." onkeydown="EngNumInput(this);" required>
				<div id="idchk-txt" class="join_check join_id_check"></div>
				<input type="hidden" class="join_check" name="idchk_join" value="false" />
				</td>
				</tr>
			<!-- 비밀번호 -->
			<tr>
			<td>
				...
				<input type="password" class="form-control join_pw" id="member_pw" name="member_pw" placeholder="8자 이상의 영문, 숫자, 특수문자 조합" required>
			...
			<td>
				...
				<input type="password" class="form-control join_pw_re" id="member_pw_re" name="member_pw_re" placeholder="비밀번호를 다시 입력해주세요." required>
			...
			<td>
				...
				<input type="email" class="form-control join_email" id="member_email" name="member_email" placeholder="이메일을 입력해주세요." onkeydown="EmailInput(this);" required>
			...
			<td>
				...
				<input type="text" class="form-control join_check join_phone" id="member_phone" name="member_phone" placeholder="-을 포함한 전화번호를 입력해주세요." onkeydown="NumSpInput(this);" required>
				<div class="check_font join_check join_phone_check" id="phone_check"></div>
			</td>
			</tr>
