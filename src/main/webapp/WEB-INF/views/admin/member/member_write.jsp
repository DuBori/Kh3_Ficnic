...
<form name="form_input" method="post"
	action="<%=request.getContextPath() %>/admin/member/memberWriteOk.do">
	<div class="page-cont">
		<div class="row">
						...
						<div class="row form my-4 view-limit">
							<div class="form-group col mb-2">
								...
								<div class="btn-group mt-2" role="group" data-toggle="buttons">
									<label class="btn btn-outline-secondary active"> <input
										type="radio" name="member_type" value="user" checked="checked" />
										일반회원
									</label> <label class="btn btn-outline-secondary"> <input
										type="radio" name="member_type" value="admin" /> 관리자
									</label>
								</div>
							</div>
							...
							<div class="form-group col">
								<label for="member_id">아이디</label> <input type="text"
									...
									class="form-control d-inline w-30"
							...
							<div class="form-group col mb-2">
								<label for="member_pw">비밀번호</label> <input type="password"
									name="member_pw" id="member_pw" class="form-control w-50"
									required />
							</div>
							<div class="form-group col mb-2">
								<label for="member_pw_re">비밀번호 확인</label> <input type="password"
									name="member_pw_re" id="member_pw_re" class="form-control w-50"
									required />
							</div>
	...
	<div class="d-flex mt-2 input-form-button">
		<div class="col-lg text-center">
			<a
				href="<%=request.getContextPath()%>/admin/member/member_list.do?search_type=${search_type}&search_name=${search_name}&search_id=${search_id}&search_email=${search_email}&search_phone=${search_phone}&page=${param.page}"
				class="btn btn-secondary btn-lg m-2"><i class="fa fa-bars"></i>
				목록보기</a>
