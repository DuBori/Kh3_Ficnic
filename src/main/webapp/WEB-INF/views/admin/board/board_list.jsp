                    ...
                    <table class="table-list mb-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<%=request.getContextPath()%>/site/board/board_list.do?bbs_id=${dto.getBoard_id()}" class="btn btn-outline-info btn-sm" target="_blank"><i class="fa fa-link"></i> 게시판 보기</a></td>
                                <td>
